...
import com.miu.assignment4.databinding.ActivityLoginBinding
import com.miu.assignment4.databinding.ActivityMainBinding
...
class activity_login : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userList.add(User("Puskar", "Budhathoki", "puskar.budhathoki@gmail.com", "puskar"))
                ...
                userList.forEach {
                    if (it == user) {
                        ...
                        startActivity(Intent(
                            this,
                            activity_shopping_category::class.java
                        ).apply {
        ...
        binding.createAccountButton.setOnClickListener {
            resultLauncher.launch(Intent(this, activity_register::class.java))
        }
